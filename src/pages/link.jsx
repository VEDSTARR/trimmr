...
const LinkPage = () => {
  ...
  let link = "";
  if (url) {
    // Prefer custom_url, then short_url, and as a final fallback use the row id
    link = url?.custom_url || url?.short_url || url?.id;
  }
        ...
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
          ...
          <div className="flex gap-2">
            <Button
              variant="ghost"
              onClick={() =>
                navigator.clipboard.writeText(`${appOrigin}/${link}`)
              }
            >
              <Copy />
            </Button>
